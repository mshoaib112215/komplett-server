...
var AuthService = {
    ...
    createUser: function (body) {
        return __awaiter(this, void 0, void 0, function () {
            var validate, user, query, saved, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        validate = auth_validation_1.default.createUser(body);
                        if (validate.error) {
    ...
    getUser: function (body) {
        return __awaiter(this, void 0, void 0, function () {
            var validate, user, isMatched, _a, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 4, , 5]);
                        validate = auth_validation_1.default.getUser(body);
                        if (validate.error) {
                            throw new Error(validate.error.message);
                        }
                        return [4 /*yield*/, user_model_1.default.findOne({
