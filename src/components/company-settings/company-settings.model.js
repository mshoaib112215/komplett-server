...
exports.defaultCompanySettings = void 0;
 ...
 *
 */
var CompanySettingsSchema = new mongoose_1.Schema({
    userId: {
...
var CompanySettingsModel = connections.db.model('CompanySettingsModel', CompanySettingsSchema);
