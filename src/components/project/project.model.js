...
var task_dao_1 = require("../task/task.dao");
/**
 * @swagger
 * components:
 *  schemas:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    self_1 = this;
                    if (!self_1.locationId) return [3 /*break*/, 2];
                    return [4 /*yield*/, location_dao_1.default.deleteRecord(self_1.locationId)];
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2:
                    ...
                    tasks.forEach(function (task) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, task_dao_1.default.deleteRecord(task)];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
...
var ProjectModel = connections.db.model('ProjectModel', projectSchema);
