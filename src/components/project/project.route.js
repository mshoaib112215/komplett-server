 ...
 *
 */
router.get('/', __1.ProjectComponent.findAllProjects);
/**
 ...
 *
 */
router.get('/:id', __1.ProjectComponent.getProjectById);
/**
 * POST method route
 ...
 */
router.post('/', __1.ProjectComponent.insertProject);
/**
 ...
 *
 */
router.get('/customer/:id', __1.ProjectComponent.findProjectByCustomerId);
/**
 * @example http://localhost:3000/api/project/5f9bc88416d62e246cd2c504
 *
 * @swagger
 ...
 *
 */
router.delete('/:id', __1.ProjectComponent.deleteProject);
/**
 * PUT method route
 * @example http://localhost:3000/api/project/
 *
 ...
 *                $ref: '#/components/schemas/Error'
 */
router.put('/', __1.ProjectComponent.updateProject);
