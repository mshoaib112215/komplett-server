...
CustomerSchema.pre('save', function (next) {
    return __awaiter(this, void 0, void 0, function () {
        var self_1, user, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    self_1 = this;
                    if (!self_1.userId) return [3 /*break*/, 2];
                    return [4 /*yield*/, user_model_1.default.findByIdAndUpdate({ _id: mongoose_1.Types.ObjectId(self_1.userId) }, { customerId: self_1._id })];
                case 1:
                    user = _a.sent();
                    _a.label = 2;
                case 2:
